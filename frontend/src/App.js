      ...
      <Router>
        ...
        >
          ...
          <Routes>
            ...
            <Route path="/services/mobile-development" element={<MobDevelopment />} />
            ...
            <Route path="/services/data-analytics-and-visualization" element={<DataVisualization />} />
           ...
           {/* BLOGS */}
            ...
            <Route path="/blogs/agile-methodologies-and-their-benefits-in-software-development" element={<Blogs1 />} />
            <Route path="/blogs/importance-of-ui-ux" element={<Blogs2 />} />
            <Route path="/blogs/future-of-web-development" element={<Blogs3 />} />
            <Route path="/blogs/devOps-and-CI-CD-in-software-development" element={<Blogs4 />} />
            <Route path="/blogs/remote-work-post-pandemic" element={<Blogs5 />} />
            <Route path="/blogs/artificial-intelligence-and-machine-learning" element={<Blogs6 />} />
            <Route path="/blogs/data-analytics-visualization-and-business-intelligence" element={<Blogs7 />} />
            
            <Route path="/contact-us" element={<Contact />} />
            
            <Route path="/get-in-touch/dashboard" element={<Get_in_touch />} />  
            <Route path="/get-in-touch/appointment" element={<Get_in_touch />} /> 
