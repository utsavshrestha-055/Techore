...
export interface ApiAppointmentAppointment extends Schema.CollectionType {
  ...
  attributes: {
    ...
    status: Attribute.Enumeration<['Approved', 'On Hold', 'Rejected']>;
...
export interface ApiInternIntern extends Schema.CollectionType {
  ...
  attributes: {
    ...
    citizenship_number: Attribute.String;
    citizenship_front: Attribute.Media;
    citizenship_back: Attribute.Media;
    issued_date: Attribute.String;
    status: Attribute.Enumeration<['APPROVED', 'ON HOLD', 'REJECTED']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
